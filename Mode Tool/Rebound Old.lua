...
local entity = spawner.Create({
	Entity = {
		Name = "Rebound Old",
		Asset = "https://github.com/arkanzulfadliputra-oss/Entities-Models/raw/main/Entity%20Model/Rebound%20Old.rbxm",
		HeightOffset = 0
	},
	Lights = {
		Flicker = {
	...
	Death = {
		...
		Hints = {"You Died By Rebound", "you have to hide 10 times", "otherwise you will be like this", "Come on, Revive for Survival", "Thank You For Playing"},
		Cause = "Rebound"
	}
})
