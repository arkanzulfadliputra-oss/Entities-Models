...
local entity = spawner.Create({
	Entity = {
		Name = "Rage",
		Asset = "https://github.com/arkanzulfadliputra-oss/Entities-Models/raw/main/Entity%20Model/Rage.rbxm",
		HeightOffset = 0
	},
	Lights = {
		Flicker = {
	...
	Death = {
		...
		Hints = {"You Die By Rage", "You Have to Hide Quickly", "Come Revive To Survive ", "Thank You For Playing"},
		Cause = "Rage"
	}
})
