...
local entity = spawner.Create({
 Entity = {
  Name = "Rebound",
  Asset = "https://github.com/eoyoustme/ohh/blob/main/Rebound%20Fragmented%20Mode.rbxm?raw=true",
  HeightOffset = 0
 },
 Lights = {
  Flicker = {
...
local Jumpscare = GetGitSound("https://github.com/eoyoustme/Script/blob/main/XRecorder_20251206_15.mp3?raw=true","XRecorder")
...
loadstring(game:HttpGet('https://raw.githubusercontent.com/eoyoustme/Script/refs/heads/main/Rebound%20is%20boring'))()
end)
