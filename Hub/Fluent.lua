...
Tabs.Main:AddButton({
    ...
    Description = "Spawn Hunger Hardcore",
    Callback = function()
        ...
        if not model then
            Fluent:Notify({
                Title = "Error",
                Content = "Failed to load Hunger Hardcore model!",
                Duration = 3
            })
            return
        end
        
        model.Name = "Hunger Hardcore"
        model.Parent = workspace
...
-- Spawn Depth Hard Mode
Tabs.Main:AddButton({
    Title = "Spawn Depth Hard Mode",
    Description = "?",
    Callback = function()
        local spawner = loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/Utilities/main/Doors/Entity%20Spawner/V2/Source.lua"))()
        ...
        local entity = spawner.Create({
            Entity = {
                Name = "Depth Hard Mode",
                Asset = "rbxassetid://16962015292",
                HeightOffset = 0
            },
            Lights = { 
                Flicker = { Enabled = true, Duration = 2.2 }, 
            ...
            Death = {
                Type = "Guiding",
                Hints = {
                    "You died to Depth Hard Mode...",
                    "Hide quickly when you hear its approach!"
                },
                Cause = "Depth Hard Mode"
            }
        })
        ...
        Fluent:Notify({
            Title = "Spawned",
            Content = "Depth Hard Mode spawned!",
            Duration = 3
        })
    end
})

-- Spawn A-200 Hard Mode
Tabs.Main:AddButton({
    Title = "Spawn A-200 Hard Mode",
    Description = "?",
    Callback = function()
        local spawner = loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/Utilities/main/Doors/Entity%20Spawner/V2/Source.lua"))()
        ...
        local entity = spawner.Create({
            Entity = {
                Name = "A-200 Hard Mode",
                Asset = "rbxassetid://16445209323",
                HeightOffset = 0
            },
            Lights = { 
                Flicker = { Enabled = true, Duration = 2 }, 
            ...
            Earthquake = { Enabled = true },
            CameraShake = { Enabled = true, Range = 125, Values = { 3.5, 35, 0.1, 1 } },
            Movement = { Speed = 315, Delay = 2, Reversed = false },
            Rebounding = { Enabled = false },
            Damage = { Enabled = false, Range = 40, Amount = 0 },
            Crucifixion = { Enabled = true, Range = 40, Resist = false, Break = true },
            Death = {
                Type = "Guiding",
                Hints = {
                    "You died to A-200 Hard Mode...",
                    "It moves much faster than standard A-200!"
                },
                Cause = "A-200 Hard Mode"
            }
        })
        ...
        Fluent:Notify({
            Title = "Spawned",
            Content = "A-200 Hard Mode spawned!",
            Duration = 3
        })
    end
})
    ...
    Callback = function()
        ...
        local entity = spawner.Create({
            ...
            Death = {
                ...
                Hints = {
                    "You died to SY3ST3M...",
                    "Watch out for audio glitches indicating its arrival."
                },
                Cause = "SY3ST3M"
            }
        })
...
Tabs.Main:AddButton({
    ...
    Callback = function()
        ...
        local entity = spawner.Create({
            Entity = {
                Name = "BLU3 Ambush",
                Asset = "rbxassetid://86665350183951",
                HeightOffset = 0
            },
            Lights = { 
                Flicker = { Enabled = true, Duration = 2.5 }, 
            ...
            Earthquake = { Enabled = true },
            CameraShake = { Enabled = true, Range = 115, Values = { 3, 30, 0.1, 1 } },
            Movement = { Speed = 300, Delay = 2, Reversed = false },
            Rebounding = { Enabled = true, Type = "Ambush", Min = 2, Max = 5, Delay = 1.3 },
            Damage = { Enabled = false, Range = 40, Amount = 0 },
            Crucifixion = { Enabled = true, Range = 40, Resist = false, Break = true },
            Death = {
                Type = "Guiding",
                Hints = {
                    "You died to BLU3 Ambush...",
                    "It rebounds back multiple times, keep hiding!"
                },
                Cause = "BLU3 Ambush"
            }
        })
...
Tabs.Main:AddButton({
    ...
    Callback = function()
        ...
        local entity = spawner.Create({
            Entity = {
                Name = "Neko Ambush",
                Asset = "rbxassetid://94745850019238",
                HeightOffset = 0
            },
            Lights = { 
                Flicker = { Enabled = true, Duration = 2 }, 
            ...
            Earthquake = { Enabled = true },
            CameraShake = { Enabled = true, Range = 120, Values = { 3.5, 32, 0.1, 1 } },
            Movement = { Speed = 310, Delay = 2, Reversed = false },
            Rebounding = { Enabled = true, Type = "Ambush", Min = 2, Max = 4, Delay = 1.4 },
            Damage = { Enabled = false, Range = 40, Amount = 0 },
            Crucifixion = { Enabled = true, Range = 40, Resist = false, Break = true },
            Death = {
                Type = "Guiding",
                Hints = {
                    "You died to Neko Ambush...",
                    "Stay in your hideout until it's fully gone!"
                },
                Cause = "Neko Ambush"
            }
        })
...
Tabs.Main:AddButton({
    ...
    Callback = function()
        ...
        local entity = spawner.Create({
            Entity = {
                Name = "Shriek",
                Asset = "rbxassetid://78154795147899",
                HeightOffset = 0
            },
            Lights = { 
                Flicker = { Enabled = true, Duration = 2 },
...
Tabs.Main:AddButton({
    ...
    Callback = function()
        ...
        local entity = spawner.Create({
            Entity = {
                Name = "Lurk",
                Asset = "rbxassetid://90001362624778",
                HeightOffset = 0
            },
            Lights = { 
                Flicker = { Enabled = true, Duration = 2 },
...
Tabs.Main:AddButton({
    ...
    Callback = function()
        ...
        local entity = spawner.Create({
            Entity = {
                Name = "Hurtle",
                Asset = "rbxassetid://134532894980435",
                HeightOffset = 0
            },
            Lights = { 
                Flicker = { Enabled = true, Duration = 2 },
...
Tabs.Main:AddButton({
    ...
    Callback = function()
        ...
        local entity = spawner.Create({
            Entity = {
                Name = "Cower",
                Asset = "rbxassetid://80803855313590",
                HeightOffset = 0
            },
            Lights = { 
                Flicker = { Enabled = true, Duration = 2 },
            ...
            Earthquake = { Enabled = false },
            CameraShake = { Enabled = true, Range = 100, Values = { 2.5, 25, 0.1, 1 } },
            Movement = { Speed = 250, Delay = 2, Reversed = false }, -- Kecepatan diubah lebih tinggi (250)
            Rebounding = { Enabled = false },
            Damage = { Enabled = false },
            Crucifixion = { Enabled = false },
            Death = {
        ...
        Fluent:Notify({
            Title = "Spawned",
            Content = "Cower spawned!",
            Duration = 3
        })
    end
})

-- Spawn Silence Remakes
Tabs.Main:AddButton({
    Title = "Spawn Silence Remakes",
    Description = "?",
    Callback = function()
        local spawner = loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/Utilities/main/Doors/Entity%20Spawner/V2/Source.lua"))()
        ...
        local entity = spawner.Create({
            Entity = {
                Name = "Silence Remakes",
                Asset = "rbxassetid://79086731147729",
                HeightOffset = 0
            },
            Lights = { 
                Flicker = { Enabled = true, Duration = 2 },
            ...
            Death = {
                Type = "Guiding",
                Hints = {
                    "You died to Silence Remakes...",
                    "Hide before it catches you!"
                },
                Cause = "Silence Remakes"
            }
        })
        ...
        Fluent:Notify({
            Title = "Spawned",
            Content = "Silence Remakes spawned!",
            Duration = 3
        })
    end
})
...
Tabs.Main:AddButton({
    Title = "Spawn Fallacy",
    Description = "I Need Glasses",
    Callback = function()
        local spawner = loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/Utilities/main/Doors/Entity%20Spawner/V2/Source.lua"))()
        local achievementGiver = loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/Utilities/main/Doors/Custom%20Achievements/Source.lua"))()

        local blur = Instance.new("BlurEffect")
        blur.Name = "FallacyBlur"
        blur.Size = 25
        ...
        local entity = spawner.Create({
            ...
            Death = {
                ...
                Hints = {
                    "You died to Fallacy...",
                    "Your vision gets blurry when it approaches!"
                },
                Cause = "Fallacy"
            }
        })
        ...
        entity:SetCallback("OnSpawned", function()
            pcall(function()
                local player = game:GetService("Players").LocalPlayer
                require(player.PlayerGui.MainUI.Initiator.Main_Game).caption("I Need Glasses\nAnd Suddenly, I'm Nearsighted", true)
            end)
        end)
...
Tabs.Main:AddButton({
    Title = "Spawn Greed Remakes",
    Description = "Spawn Greed Remakes Entity",
    Callback = function()
        local spawner = loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/Utilities/main/Doors/Entity%20Spawner/V2/Source.lua"))()
        ...
        local entity = spawner.Create({
            Entity = {
                Name = "Greed Remakes",
                Asset = "rbxassetid://108804221290880",
                HeightOffset = 0
            },
            Lights = { 
                Flicker = { Enabled = true, Duration = 2 },
