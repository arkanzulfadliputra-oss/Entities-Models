...
local TabCustomEntity = Window:CreateTab("Custom Entity", 99226763923744)
local SectionCustomEntity = TabCustomEntity:CreateSection("Entity Collection")
